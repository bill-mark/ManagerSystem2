...
@section('content')
    <div class="pd-20">
        <div class="cl pd-5 bg-1 bk-gray">
  		<span class="l">
  			<a href="javascript:;" onclick="project_add('添加项目','/manager/project/add')" class="btn btn-success radius"><i
                    ...
                    <tr class="text-c">
                        ...
                        <td>
                            <a title="测试" href="javascript:;"
                               onclick="customer_content('查看详情','/manager/project_detail?id={{$item->id}}&from=saler')" class="ml-5"
