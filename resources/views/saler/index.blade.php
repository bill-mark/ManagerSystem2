    ...
    <aside class="Hui-aside">
        ...
        <div class="menu_dropdown bk_2">
            <dl id="menu-product">
                ...
                <dd>
                    <ul>
                        <li><a _href="customer_list?reset=1" data-title="客户"
                               href="javascript:void(0)">客户列表页</a></li>
                    </ul>
                </dd>
            </dl>
            <dl id="menu-order">
                ...
                <dd>
                    <ul>
                        <li><a _href="project_list"
                               data-title="项目列表"
                               href="javascript:void(0)">项目列表页</a></li>
                    </ul>
                </dd>
            </dl>
            <dl id="menu-order">
                ...
                <dd>
                    <ul>
                        <li><a _href="account_manage" data-title="帐号管理" href="javascript:void(0)">管理帐号</a></li>
                        </li>
                    </ul>
                </dd>
            </dl>
